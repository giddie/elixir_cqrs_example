defmodule CqrsMemorySyncWeb.Router do
  use CqrsMemorySyncWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {CqrsMemorySyncWeb.Layouts, :root}
  ...
  # scope "/api", CqrsMemorySyncWeb do
  #   pipe_through :api
  # end
  ...
  if Application.compile_env(:cqrs_memory_sync, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CqrsMemorySyncWeb.Telemetry
